...
public class DoubleManipulatorTest 
{
	...
	public void removeExponent()
	{
		...
		assertEquals("123456.00236", _dm.formatNumber("123456.002355"));
	...
	public void formatDoubles()
	{
		...
		assertEquals("G82 X0.70285 Y-0.0006 Z[#100 + -0.01]", _dm.formatOutput("G82 X0.7028467 Y-6.0E-4 Z[#100 + -0.010000]"));
		assertEquals("G1 X1.09955 Y-0.02674 Z[#100 + -0.00302]", _dm.formatOutput("G01 X1.0995543 Y-0.0267432 Z[#100 + -0.003023]"));
